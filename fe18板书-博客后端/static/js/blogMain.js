...
var blogTemplate = function(blog) {
    ...
    <div class="gua-blog-cell">
        ...
        <div class="blog-comments">
            <div class='new-comment gua-auto-form'>
                <input class='comment-blog-id gua-auto-input' data-key="blog_id" type=hidden value="${id}">
                <input class='comment-author gua-auto-input' data-key="author" value="">
                <input class='comment-content gua-auto-input' data-key="content" value="">
                <button class='comment-add gua-auto-submit'
                        data-method="POST"
...
var bindGuaAuto =function () {
    var body = e('body')
    body.addEventListener('click', function (event) {
        var self = event.target
        if(self.classList.contains('gua-auto-submit')) {
            var dx = self.closest('.gua-auto-form')
            var form = {}
            var inputs = dx.querySelectorAll('.gua-auto-input')
            for(var i = 0; i < inputs.length; i++) {
                var input = inputs[i]
                form[input.dataset.key] = input.value
            }
